  ...
  await tx.activity.createMany({
    data: [
      // first day
      {
        ...
        startsAt: dayjs().add(3, "day").set("hour", 12).set("minute", 0).set("second", 0).toDate(),
        endsAt: dayjs().add(3, "day").set("hour", 13).set("minute", 0).set("second", 0).toDate(),
      },
      {
        name: "Lol: montando o PC ideal",
        capacity: 30,
        eventRoomId: room1.id,
        startsAt: dayjs().add(3, "day").set("hour", 13).set("minute", 0).set("second", 0).toDate(),
        endsAt: dayjs().add(3, "day").set("hour", 14).set("minute", 0).set("second", 0).toDate(),
      },
      {
      ...
      // second day
      {
        ...
        capacity: 30,
        eventRoomId: room2.id,
        startsAt: dayjs().add(4, "day").set("hour", 12).set("minute", 0).set("second", 0).toDate(),
        endsAt: dayjs().add(4, "day").set("hour", 13).set("minute", 0).set("second", 0).toDate(),
      },
      {
        name: "Lol: montando o PC ideal",
        capacity: 40,
        eventRoomId: room2.id,
        startsAt: dayjs().add(4, "day").set("hour", 13).set("minute", 0).set("second", 0).toDate(),
        endsAt: dayjs().add(4, "day").set("hour", 14).set("minute", 0).set("second", 0).toDate(),
      },
      {
        name: "JS no web development",
        capacity: 50,
      ...
      // third day
      {
        ...
        capacity: 30,
        eventRoomId: room3.id,
        startsAt: dayjs().add(5, "day").set("hour", 12).set("minute", 0).set("second", 0).toDate(),
        endsAt: dayjs().add(5, "day").set("hour", 13).set("minute", 0).set("second", 0).toDate(),
      },
      {
        name: "Lol: montando o PC ideal",
        capacity: 50,
        eventRoomId: room3.id,
        startsAt: dayjs().add(5, "day").set("hour", 13).set("minute", 0).set("second", 0).toDate(),
        endsAt: dayjs().add(5, "day").set("hour", 14).set("minute", 0).set("second", 0).toDate(),
      },
      {
        name: "JS no web development",
        capacity: 50,
